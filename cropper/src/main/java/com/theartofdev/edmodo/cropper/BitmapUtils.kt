...
internal object BitmapUtils {
    ...
    fun writeBitmapToUri(context: Context, bitmap: Bitmap?, uri: Uri?, compressFormat: CompressFormat?, compressQuality: Int) {
     ...
     */
    fun resizeBitmap(bitmap: Bitmap?, reqWidth: Int, reqHeight: Int, options: RequestSizeOptions): Bitmap? {
        try {
    ...
    private fun cropBitmap(context: Context, loadedImageUri: Uri, points: FloatArray, degreesRotated: Int,
        ...
        return if (result != null) {
            ...
            cropBitmap(context, loadedImageUri, points, degreesRotated, fixAspectRatio, aspectRatioX, aspectRatioY, sampleMulti,
     ...
     */
    private fun cropForRotatedImage(bitmap: Bitmap?, points: FloatArray, rect: Rect, degreesRotated: Int,
    ...
    private fun rotateAndFlipBitmapInt(bitmap: Bitmap, degrees: Int, flipHorizontally: Boolean, flipVertically: Boolean): Bitmap {
        return if (degrees > 0 || flipHorizontally || flipVertically) {
            ...
            matrix.postScale(if (flipHorizontally) -1f else 1.toFloat(), if (flipVertically) -1f else 1.toFloat())
